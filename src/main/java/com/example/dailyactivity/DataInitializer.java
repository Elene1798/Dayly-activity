...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        saveIfMissing(
                "Задайте несколько вопросов друг другу",
                "Задайте друг другу 5 вопросов и попробуйте узнать друг друга немного лучше",
                "couple", 30, "friends",
                """
                1. По очереди задавайте друг другу вопросы
                2. Не перебивайте и внимательно слушайте ответ
                3. Можно придумывать свои вопросы или взять из задания
                4. Постарайтесь отвечать честно и подробно
                
                Вопросы:
                1. Где бы ты сейчас хотел оказаться: на море или в горах?
                2. Какое воспоминание из детства твое любимое?
                3. Какое воспоминание из детства самое грустное?
                4. Если бы была возможность полететь в космос, на какую планету ты бы хотел попасть?
                5. Кем ты хотел работать, когда учился в школе?               
                """,
                "Помогает лучше узнать друг друга и провести время вместе",
                "Иногда один неожиданный вопрос может привести к разговору, который запомнится надолго",
                null, null, null
        );
